...
//
//  case class Put(keyInput: String, valueInput: Int) extends Command
//
//  case class Get(sender: ActorRef[State]) extends Command
//
//  case class State(value: ddata.LWWMap[String, Int])
//
//  //case class State(value: ddata.LWWMap.empty[String, Int])
//
...
//  private var wantToWrite: Boolean = false
//
//
...
//      Behaviors.same
//
//    case Put(keyInput: String, valueInput: Int) =>
//        // key = keyInput
//        // value = valueInput
//        // wantToWrite = true
//        // readFunc(ki)
//        ctx.log.info(s"CRDTActor-$id: Consuming operation $keyInput -> $valueInput")
//        crdtstate = crdtstate.put(selfNode, keyInput, valueInput)
//        ctx.log.info(s"CRDTActor-$id: CRDT state: $crdtstate")
//        broadcastAndResetDeltas()
//        Behaviors.same
//
//    case Get(sender) => //ping
//        sender ! State(crdtstate) //pong
//        Behaviors.same
//
//  Behaviors.same
//}
